...
pub mod rman {
    ...
    impl<'a> File<'a> {
        ...
        pub fn size(&self) -> u32 {
            ...
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe { self._tab.get::<u32>(File::VT_SIZE, Some(0)).unwrap()}
        }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> FileBuilder<'a, 'b, A> {
        ...
        pub fn add_size(&mut self, size: u32) {
            self.fbb_.push_slot::<u32>(File::VT_SIZE, size, 0);
        }
    ...
    pub struct ChunkingParamBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
        fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
    }

    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ChunkingParamBuilder<'a, 'b, A> {
        #[inline]
        pub fn add_unk0(&mut self, unk0: u16) {
        ...
        #[inline]
        pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> ChunkingParamBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    #[inline]
    pub fn finish_size_prefixed_manifest_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Manifest<'a>>
    ) {
